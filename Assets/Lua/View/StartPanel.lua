...
function StartPanel.Awake(obj)
	...
	btn_vi = start_panel_:Find("btn_vi")
	btn_eng = start_panel_:Find("btn_eng")
	...
	lua_script:AddButtonEvent(btn_eng.gameObject, "click", StartPanel.Click)
	lua_script:AddButtonEvent(btn_vi.gameObject, "click", StartPanel.Click)
...
function StartPanel.Click(obj)
	...
	elseif(obj.name == "btn_eng") then
		btn_eng.gameObject:SetActive(false)
		btn_vi.gameObject:SetActive(true)
		StartPanel.UpdateLang(1)
	elseif(obj.name == "btn_vi") then
		btn_eng.gameObject:SetActive(true)
		btn_vi.gameObject:SetActive(false)
		StartPanel.UpdateLang(2)
...
function StartPanel.UpdateLang(lang)
	log("StartPanel.UpdateLang"..lang)
	platform_config_common.languageType = lang
	local labelStart = start_panel_:Find("start_btn/Label"):GetComponent("UILabel")
	labelStart.text = lang == 1 and 'Bắt đầu' or 'Start'
	local labelAcc = set_btn_:Find("Label"):GetComponent("UILabel")
	labelAcc.text = lang == 1 and 'Tài khoản' or 'Account'
